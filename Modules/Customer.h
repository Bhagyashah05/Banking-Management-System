...
void addFeedback(int connectionFD){
    ...
    bzero(writeBuffer, sizeof(writeBuffer));
    bzero(readBuffer, sizeof(readBuffer));
    strcpy(writeBuffer, "Please Enter Your Ratings:\n1.1 star \n2. 2 star\n3. 3 star\n4. dhruv star\n5. moon\n");
    write(connectionFD, writeBuffer, sizeof(writeBuffer));
    ...
    if(choice == 1)
    {
        strcpy(fb.feedback, "1 star");
    }
    else if(choice == 2)
    {
        strcpy(fb.feedback, "2 star");
    }
    else if(choice == 3)
    {
        strcpy(fb.feedback, "3 star");
    }
    else if(choice == 4)
    {
        strcpy(fb.feedback, "dhruv star");
    }else if(choice == 5)
    {
        strcpy(fb.feedback, "moon");
    }
